...
![color-scheme なし / あり の見た目比較](./color-scheme-comparison.png)
...
![ロード時系列の比較](./color-scheme-timeline.png)
...
![ArticleCard LCP 最適化の Before / After](./lcp-article-card-comparison.png)
