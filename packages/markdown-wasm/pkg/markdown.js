 ...
 * @returns {string}
 */
function convertMarkdownWithResources(markdown, resources) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.convertMarkdownWithResources(ptr0, len0, resources);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.convertMarkdownWithResources = convertMarkdownWithResources;
...
const wasmPath = `${__dirname}/markdown_bg.wasm`;
